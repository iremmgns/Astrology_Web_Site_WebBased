<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oglak.aspx.cs" Inherits="web_based_astrology_web_site.oglak" MasterPageFile="~/master.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/oglak_detail.png") %>" alt="OĞLAK Burcu" />
        <h2>OĞLAK Burcu</h2>
    </div>
