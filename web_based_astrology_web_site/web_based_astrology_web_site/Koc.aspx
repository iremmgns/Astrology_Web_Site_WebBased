<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Koc.aspx.cs" Inherits="web_based_astrology_web_site.Koc" MasterPageFile="~/master.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/koc_detail.png") %>" alt="Koç Burcu" />
        <h2>Koç Burcu</h2>
    </div>
