<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aslan.aspx.cs" Inherits="web_based_astrology_web_site.aslan" MasterPageFile="~/master.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .header-with-image img {
            margin-right: 40px; /* Resim ile metin arasında boşluk bırakır */
            width: 220px; /* Resmin genişliğini ayarlar */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/aslan_detail.png") %>" alt="ASLAN Burcu" />
        <h2>ASLAN Burcu</h2>
    </div>
