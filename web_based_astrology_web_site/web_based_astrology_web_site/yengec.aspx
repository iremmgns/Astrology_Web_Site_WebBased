<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yengec.aspx.cs" Inherits="web_based_astrology_web_site.yengec" MasterPageFile="~/master.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/yengec_detail.png") %>" alt="YENGEÇ Burcu" />
        <h2>YENGEÇ Burcu</h2>
    </div>
