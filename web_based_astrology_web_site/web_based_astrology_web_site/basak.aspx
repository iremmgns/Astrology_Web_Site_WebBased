<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="basak.aspx.cs" Inherits="web_based_astrology_web_site.basak" MasterPageFile="~/master.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/basak_detail.png") %>" alt="BAŞAK Burcu" />
        <h2>BAŞAK Burcu</h2>
    </div>
