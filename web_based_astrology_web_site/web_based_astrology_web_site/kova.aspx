<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kova.aspx.cs" Inherits="web_based_astrology_web_site.kova" MasterPageFile="~/master.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .header-with-image img {
            margin-right: 40px; /* Resim ile metin arasında boşluk bırakır */
            width: 270px; /* Resmin genişliğini ayarlar */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/kova_detail.png") %>" alt="KOVA Burcu" />
        <h2>KOVA Burcu</h2>
    </div>
