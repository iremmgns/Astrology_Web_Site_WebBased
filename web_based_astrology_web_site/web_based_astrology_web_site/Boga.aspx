<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Boga.aspx.cs" Inherits="web_based_astrology_web_site.Boga" MasterPageFile="~/master.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .header-with-image img {
            margin-right: 40px; /* Resim ile metin arasında boşluk bırakır */
            width: 240px; /* Resmin genişliğini ayarlar */
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/boga_detail.png") %>" alt="Boğa Burcu" />
        <h2>Boğa Burcu</h2>
    </div>
