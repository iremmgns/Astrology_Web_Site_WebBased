<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="terazi.aspx.cs" Inherits="web_based_astrology_web_site.terazi" MasterPageFile="~/master.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .header-with-image img {
            margin-right: 40px; /* Resim ile metin arasında boşluk bırakır */
            width: 280px; /* Resmin genişliğini ayarlar */
            height: 220px; /* Oranını korumak için otomatik */
        }
    </style>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header-with-image">
        ...
        <img src="<%= ResolveUrl("~/images/terazi_detail.png") %>" alt="TERAZİ Burcu" />
        <h2>TERAZİ Burcu</h2>
    </div>
